...
5? Progressive Stat Total: ranging from being able to take 4-5 Stat Cats to 6-7 Cats
Disordered Cats: May Take Cats that have Disorders
...
You are only allowed to take Cats with disorders of you have "Disordered Cats" Disorders are the red passives, aka diseases

If you enabled stat totals in your yaml, check that the cats you want to take onto an adventure do not exceed your allowed stat total. Stat Total starts at 32, for each Progressive Stat Total add 4 (if you have all… stat total is infinite). Compare this number with the effective stats of each cat (incl. Mutations etc.) 
If your cats stats are too high for this restriction, I recommend playing with stat totals off or ending day or just taking your lowest stat cats
...
The same is true for disorders. If you get one during a run, you are still allowed to use that cat, even if you don't have "Disordered Cats"
